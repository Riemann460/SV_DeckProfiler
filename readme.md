...
*   **웹 서비스 배포:** `Google Cloud Run (Docker 컨테이너 기반)`을 사용하여 다른 사용자들도 이용할 수 있는 웹 서비스 형태로 배포를 진행 중입니다.

## 5. 변경 내역

### v0.4 (2025-11-10)
*   **Dockerfile 및 Selenium 환경 구축 진행 중:**
    *   로컬에서 Dockerfile을 이용한 컨테이너 빌드 및 실행 테스트를 진행하고 있습니다.
